      ...
      <div className="grid min-h-screen grid-cols-[236px_1fr]">
          ...
          <div className="border-b border-blue-800 px-4 py-4.5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h1 className="text-lg font-extrabold leading-tight tracking-[0.05em] text-white">
                  LGU DASHBOARD
                </h1>
                <p className="text-[10px] uppercase tracking-[0.14em] text-blue-200/90">
                  Laguna | Command Center
                </p>
              </div>
            </div>
          </div>
        ...
        <main className="flex flex-col">
          <header className="flex items-center justify-between border-b border-slate-200 bg-white px-6 py-3.5">
            <h2 className="text-[32px] font-semibold tracking-tight text-slate-800">
              Dashboard
            </h2>
            <div className="flex items-center gap-3">
