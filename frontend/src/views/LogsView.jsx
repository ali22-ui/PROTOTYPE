  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <h3 className="text-[28px] font-semibold tracking-tight text-slate-800">System Logs</h3>
        <p className="mt-1 text-sm text-slate-500">Operational events for map, reports, and enterprise monitoring.</p>
